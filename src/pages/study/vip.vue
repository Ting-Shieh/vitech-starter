  ...
  <div class="bg-gray-100">
        ...
        <div class="bg-white p-4">
          <div class="flex justify-between items-center mb-10">
            <div class="flex flex-col">
              <span class="text-xl mb-2">學院會員</span>
              <span class="text-xs text-gray-400 line-clamp-1"
              >優質專欄、每日一課免費閱讀、精品微課折扣</span
              >
            </div>
            <div class="text-orange text-2xl">TWD 5,999/年</div>
          </div>
        ...
        <div class="bg-white p-4">
          <div class="flex justify-between items-center mb-10">
            <div class="flex flex-col">
              <span class="text-xl mb-2">學院會員</span>
              <span class="text-xs text-gray-400 line-clamp-1"
                >優質專欄、每日一課、精品微課免費閱讀、學習計畫專展折扣</span
              >
            </div>
            <div class="text-orange text-2xl">TWD 7,999/年</div>
          </div>
          <div class="text-center">
            <div class="btn px-8 inline-block">立即加入</div>
          </div>
    ...
    <Container class="flex-col">
      <div class="text-3xl pb-4 pt-10 w-full text-center">
        <p>學習計畫</p>
        <p class="text-xl text-gray-400">會員享8折，高級會員享6折優惠</p>
      </div>
    ...
    <Container class="pb-10">
      <div class="btn mx-auto">高級會員專屬-立即加入</div>
    </Container>
  </div>
</template>
